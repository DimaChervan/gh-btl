...
const UserDetails = ({ score, info: { avatar_url, name, login, location,
    company, followers, following, public_repos, blog } }) => (
  <div>
    {typeof score === 'number' && <li className="list-group-item"><h3>Score: {score}</h3></li>}
    <li className="list-group-item"> <img src={avatar_url} className="img-rounded img-responsive center-block"/></li>
